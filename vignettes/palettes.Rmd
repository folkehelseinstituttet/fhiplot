...
q <- q + geom_polygon(data = pd, aes( x = long, y = lat, group = group, fill=category), color="black", size=0.25)
q <- q + coord_quickmap()
q <- q + fhiplot::scale_fill_fhi("Category",palette = "map_div_complete", direction = 1)
...
q <- q + coord_quickmap()
q <- q + fhiplot::scale_fill_fhi("Category",palette = "map_seq_missing", direction = 1)
...
q <- q + geom_polygon(data = pd, aes( x = long, y = lat, group = group, fill=category_with_missing), color="black", size=0.25)
q <- q + coord_quickmap()
q <- q + fhiplot::scale_fill_fhi("Category",palette = "map_div_missing", direction = 1)
...
q <- ggplot(diamonds, aes(x=color, fill = cut))
q <- q + geom_bar()
q <- q + fhiplot::scale_fill_fhi(palette = "combination")
q <- q + labs(title="Palette: 'combination'")
q <- q + theme_fhi_basic()
q
```
...
q <- ggplot(diamonds, aes(x=color, fill = cut))
q <- q + geom_bar()
q <- q + fhiplot::scale_fill_fhi(palette = "contrast")
q <- q + labs(title="Palette: 'contrast'")
q <- q + theme_fhi_basic()
q
```
