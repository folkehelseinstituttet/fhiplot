...
q <- q + theme_void()
q <- q + coord_quickmap()
q <- q + fhiplot::scale_fill_fhi("Category",palette = "map_seq_missing_yellow", direction = 1, drop=F)
q <- q + labs(title = "Norwegian counties with 2020 borders")
q
```
...
q <- q + theme_void()
q <- q + coord_quickmap()
q <- q + fhiplot::scale_fill_fhi("Category",palette = "map_seq_missing_gray", direction = 1, drop=F)
q <- q + labs(title = "Norwegian counties with 2020 borders")
q
```
