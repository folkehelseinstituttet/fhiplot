...
huxtable_theme_fhi_basic <- function(ht, position = "center") {
  ...
  ht <- huxtable::set_left_padding(ht, huxtable::everywhere, huxtable::everywhere, 0.1)
  ht <- huxtable::set_right_padding(ht, huxtable::everywhere, huxtable::everywhere, 0.1)
  ht
}
